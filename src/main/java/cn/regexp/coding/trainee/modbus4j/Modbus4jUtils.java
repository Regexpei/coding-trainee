...
/**
 * @author Regexpei
 * @date 2024/8/29 23:45
 * @description
 * @since 1.0.0
 */
public class Modbus4jUtils {

    public final static ModbusFactory MODBUS_FACTORY = new ModbusFactory();
    ...
    public static void main(String[] args) throws ModbusInitException, ModbusTransportException, ErrorResponseException {
        ...
        // 初始化并建立链接
        SerialPortWrapperImpl wrapper = new SerialPortWrapperImpl(commPortId, 9600, 50, 50, 8, 1, SerialPort.NO_PARITY);
